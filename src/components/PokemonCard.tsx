...
function PokemonCard(props: any) {
  // Change the pokemon ID when the user clicks on a new pokemon
  const [PokemonId, setPokemonId] = useState(props.PokemonId);
  ...
  if (props.PokemonId === "") {
    ...
    return (
      <div>
        <div className=" fixed bottom-0 right-30 gap-2 bg-white rounded-xl items-center w-[350px] h-[750px]">
                ...
                {Pokemon.abilities.map((ability, idx) => (
                  ...
                  >
                    ...
                    <span className="m-auto flex justify-end">
                      {" "}
                      {ability.is_hidden ? <AiOutlineEyeInvisible /> : ""}{" "}
                    </span>
                  </div>
                ))}
              </div>
